...
describe('native worktree contract fields', () => {
  ...
  it('preserves worktree_mode when normalizing a manifest-only team', async () => {
    ...
    const manifest: TeamManifestV2 = {
      ...
      policy: { display_mode: 'split_pane', worker_launch_mode: 'interactive', communication: 'inbox_outbox', coordination: 'centralized_leader' },
      governance: { autonomy: 'guided', escalation: 'leader', checkpoints: [] },
